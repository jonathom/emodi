...
load("./mask_preds_resp_europe.Rdata")
results_root <- "~/iloek_job/wadoux/deBruin_add_nndm/debruin/CVresults"
samples_root <- "~/iloek_job/wadoux/deBruin_add_nndm/debruin/samples"
...
for (method in list.files("./CVresults")) {
  ...
  for (smpl in samples) {
    for (iteration in 1:3){ # 1:length(out_files)) {
      ...
      if (method == "spatial") {
          ...
          for (i in 1:3) {
            ...
            gd <- sampled_geodist(x = AGBdata, modeldomain = mask, cvfolds = folds_i, 
