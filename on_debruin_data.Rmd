...
```{r}
fg <- CAST::plot_geodist(x = saps, modeldomain = rs, cvfolds = saps$folds, stat = "ecdf")
gh <- CAST::plot_geodist(x = saps, modeldomain = rs, stat = "ecdf")
hj <- sampled_geodist(pts, mask, cvfolds = TRUE, samples = 200)
